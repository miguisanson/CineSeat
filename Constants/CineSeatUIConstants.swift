...
enum CineSeatFont {
    ...
    static let caption = UIFont.monospacedSystemFont(ofSize: 14, weight: .medium)
    static let metadata = UIFont.monospacedSystemFont(ofSize: 14, weight: .regular)
    static let metadataSemibold = UIFont.monospacedSystemFont(ofSize: 14, weight: .semibold)
    static let infoValue = UIFont.monospacedSystemFont(ofSize: 15, weight: .semibold)
    static let button = UIFont.monospacedSystemFont(ofSize: 13, weight: .bold)
    static let status = UIFont.monospacedSystemFont(ofSize: 13, weight: .bold)
    static let seat = UIFont.monospacedSystemFont(ofSize: 12, weight: .bold)
